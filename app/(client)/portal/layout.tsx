...
export default async function ClientPortalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className="min-h-screen min-w-0 overflow-x-hidden bg-os-bg px-4 py-6 text-os-text sm:px-6 lg:px-8">
      <div className="mx-auto mb-6 flex max-w-6xl items-center justify-between border-b border-os-border pb-4">
        <div>
          ...
          <div className="mt-0.5 font-mono text-[10px] uppercase tracking-[0.16em] text-os-muted">Portal de cliente</div>
        </div>
        <LogoutButton />
      </div>
      {children}
