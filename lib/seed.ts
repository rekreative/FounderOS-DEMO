...
const leadMagnets: LeadMagnet[] = [
  {
    id: 'guia-captacion-psicologos',
    name: 'Guía — Cómo captar pacientes sin depender de Doctoralia',
    offer: 'Una guía práctica para psicólogos y centros que quieren construir un sistema propio de captación.',
    url: 'https://guia-captacion-psicologos.example.com',
    status: 'live',
    captures: 'email',
    destination: 'Newsletter · lista principal',
    source: 'Carrusel Instagram · "Deja de depender de Doctoralia" (comenta GUIA)',
    launchedAt: '2026-08-12',
    origin: 'seed',
    notes: 'Acceso libre. Formulario de email, con una casilla opcional para agendar la auditoría gratuita.',
  },
  {
    id: 'auditoria-captacion-psicologia',
    name: 'Auditoría — Sistema de captación para centros de psicología',
    offer: 'Diagnóstico de campañas, cualificación, seguimiento y conversión para detectar dónde se pierden oportunidades.',
    url: 'https://auditoria-captacion-psicologia.example.com',
    status: 'live',
    captures: 'booking',
    destination: 'Calendario · reserva de auditoría',
    source: 'Anuncio Meta · "¿Dónde se pierden tus leads?" (formulario instantáneo)',
    launchedAt: '2026-08-05',
    origin: 'seed',
    notes: 'Sesión de 20 minutos por videollamada, pensada para centros que ya invierten en Meta Ads.',
  },
  {
    id: 'checklist-meta-ads-psicologia',
    name: 'Checklist — Antes de invertir en Meta Ads',
    offer: 'Los puntos que un psicólogo o centro debería tener preparados antes de empezar a captar leads.',
    url: 'https://checklist-meta-ads-psicologia.example.com',
    status: 'paused',
    captures: 'email',
    destination: 'Newsletter · segmento centros de psicología',
    source: 'Bio de Instagram + cierres de vídeo',
    launchedAt: '2026-07-28',
    origin: 'seed',
    notes: 'Pausado mientras se actualiza con los nuevos requisitos de Meta para el sector salud.',
  },
];
